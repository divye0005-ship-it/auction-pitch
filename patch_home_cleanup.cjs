...
// The JSX should just return the buttons, no need for the selectedMode or matchmakingState logic.
// Find where the `return` starts and replace everything inside.
  ...
  return (
    <div className="h-full overflow-y-auto pb-24 hide-scrollbar">
      ...
      <div className="space-y-4 px-4">
        ...
        {/* Real Estate Card (Disabled) */}
        <div className="bento-item bg-gradient-to-br from-green-900/30 to-emerald-900/30 border border-green-500/20 opacity-60 cursor-not-allowed mt-4 relative overflow-hidden">
          <div className="flex items-center gap-4 relative z-10">
            <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-green-600/50 to-emerald-400/50 flex items-center justify-center">
            ...
            <div className="flex-1">
              <h3 className="text-xl font-black uppercase tracking-widest text-emerald-100/70 mb-1">Real Estate</h3>
              <p className="text-xs text-green-300/50 font-bold">Coming Soon</p>
            </div>
          </div>
        </div>
      </div>
...
fs.writeFileSync('src/components/HomeTab.tsx', newComponent);
console.log('Cleaned HomeTab');
